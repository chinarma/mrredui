...
import TableDoc from "@/views/doc/table/index.vue";
import RToolTipDoc from "@/views/doc/rtooltip/index.vue";
...
const docMenus = {
    ...
    复杂组件: [{ path: "table", component: TableDoc, name: "表格 Table" }],
    组件指令: [
        { path: "tooltip", component: RToolTipDoc, name: "提示 v-tooltip" },
    ],
};
