<template>
    <div class="r-tabs" :class="classes">
        <div class="r-tabs-header" ref="container">
            <div
                class="r-tabs-header-item"
...
slots.forEach((tag) => {
    // @ts-ignore
    if (tag.type.name !== RTab.name) {
        throw new Error("RTabs 子标签必须是RTab");
    }
});
