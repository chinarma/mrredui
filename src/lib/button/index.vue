<template>
    <button class="r-button" :class="classes">
        ...
        <div
            v-if="iconPlacement === 'left' && solts.icon"
        ...
        <slot></slot>
        <div
            v-if="iconPlacement === 'right' && solts.icon"
...
.r-button {
    ...
    &.is-circle.r-button-default {
        border-radius: 100%;
        height: $h-default;
        width: $h-default;
    }
    &.is-circle.r-button-small {
        border-radius: 100%;
        height: $h-small;
        width: $h-small;
    }
    &.is-circle.r-button-large {
        border-radius: 100%;
        height: $h-large;
        width: $h-large;
    }
    &.is-round.r-button-default {
        border-radius: calc($h-default / 2);
    }
    &.is-round.r-button-large {
        border-radius: calc($h-large / 2);
    }
    &.is-round.r-button-small {
    ...
    &.r-theme-primary {
        ...
        &.is-dashed {
            ...
            > .r-loadingIndicator {
                border-style: dashed;
                border-color: $primary-color $primary-color $primary-color
                    transparent;
            }
        }
    }
